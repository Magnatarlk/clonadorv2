...
client.on("ready", async () => {
  ...
  const r = new Discord.RichPresence()
    ...
    .setType('PLAYING')
    .setURL('https://discord.gg/8mvazamentos')
    .setName('8mvazamentos')
    .setState('Running...')
    .setDetails('VAZAMOS QUASE TUDO')
    ...
    .setAssetsLargeText('8mvazamentos')
    ...
    .addButton('Join', 'https://discord.gg/8mvazamentos');
